...
chosen_start_date = '2019-01-01'
chosen_end_date = '2019-10-30'

house_num = 'powerblade_2019'
...
def get_data(path = '/Users/nelson/Academia/Research/Work/SmartHEMS/Prediction/Data Source/powerblade_select/2019'):
    ...
    for file in os.listdir(path):
        ...
        if file == 'powerblade_data_power_2019_c098e57000a9_TV.data':
        	power_threshold = 40
        if file == 'powerblade_data_power_2019_c098e570015c_Mac_Charger.data':
            power_threshold = 15
        if file == 'powerblade_data_power_2018_c098e5700156_Monitor.data':
            power_threshold = 2
        if file == 'powerblade_data_power_2019_c098e5700159_Laptop_Docking_Station.data':
            power_threshold = 2
        if file == 'powerblade_data_power_2019_c098e5700244_Black_and_white_printer.data':
            power_threshold = 15
        if file == 'powerblade_data_power_2019_c098e5700246_Color_printer.data':
            power_threshold = 20
        if file == 'powerblade_data_power_2018_c098e5700149_Desktop.data':
            power_threshold = 5
        ...
        for row in tqdm(datas, desc = "Reading power data from %s"%file):
            ...
            dttime = datetime.datetime.strptime(time, '%Y-%m-%dT%H:%M:%S')
