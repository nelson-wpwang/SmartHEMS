...
def batch_shuffle(data_dir, indices_dir, batch_size=8, max_size=8):
    ...
    shuffled_train = os.path.join(shuffled_dir, 'shuffled_train.pkl')
    shuffled_test = os.path.join(shuffled_dir, 'shuffled_test.pkl')
...
def sample_usage(dev_num, wod, times, dis_path='./data/distribution.pkl'):
...
if __name__ == '__main__':
    batch_shuffle('/Users/nelson/Academia/Research/Work/SmartHEMS/Prediction/Data Source/114_dataset.pkl', '/Users/nelson/Academia/Research/Work/SmartHEMS/Prediction/Data Source/114_indexing.pkl', batch_size=8, max_size=8)
